4497
((3) 0 () 13 ((q lib "file/gif.rkt") (q lib "file/gunzip.rkt") (q lib "file/glob.rkt") (q lib "file/resource.rkt") (q lib "file/unzip.rkt") (q lib "file/gzip.rkt") (q lib "file/ico.rkt") (q lib "file/tar.rkt") (q lib "file/zip.rkt") (q 10397 . 4) (q lib "file/sha1.rkt") (q lib "file/convertible.rkt") (q lib "file/cache.rkt")) () (h ! (equal) ((c def c (c (? . 2) q glob-capture-dotfiles?)) q (23154 . 5)) ((c def c (c (? . 1) q gunzip)) q (4620 . 5)) ((c def c (c (? . 8) q zip-verbose)) q (7128 . 4)) ((c def c (c (? . 0) q empty-gif-stream?)) q (15677 . 3)) ((c def c (c (? . 4) q unzip)) q (7214 . 13)) ((c def c (c (? . 3) q write-resource)) q (19680 . 13)) ((c def c (c (? . 0) q gif-end)) q (17398 . 3)) ((c def c (c (? . 1) q inflate)) q (4943 . 4)) ((c def c (c (? . 0) q image-or-control-ready-gif-stream?)) q (15597 . 3)) ((c def c (c (? . 5) q deflate)) q (4417 . 6)) ((c def c (c (? . 2) q glob-quote)) q (23044 . 5)) ((c def c (c (? . 3) q get-resource)) q (19186 . 13)) ((c def c (c (? . 6) q ico-depth)) q (17900 . 3)) ((c def c (c (? . 4) q zip-directory-contains?)) q (8943 . 4)) ((c def c (c (? . 4) q exn:fail:unzip:no-such-entry-entry)) c (? . 9)) ((c def c (c (? . 5) q gzip-through-ports)) q (4098 . 9)) ((c def c (c (? . 6) q argb->ico)) q (18909 . 6)) ((c def c (c (? . 4) q unzip-entry)) q (9271 . 18)) ((c def c (c (? . 6) q ico->argb)) q (18792 . 3)) ((c def c (c (? . 4) q zip-directory-includes-directory?)) q (9079 . 5)) ((c def c (c (? . 6) q ico-height)) q (17826 . 3)) ((c def c (c (? . 4) q zip-directory-entries)) q (8849 . 3)) ((c def c (c (? . 7) q tar)) q (10551 . 23)) ((c def c (c (? . 6) q png-bytes->ico)) q (19123 . 3)) ((c def c (c (? . 7) q tar-gzip)) q (12504 . 20)) ((c def c (c (? . 10) q bytes->hex-string)) q (15335 . 3)) ((c def c (c (? . 8) q zip->output)) q (6055 . 21)) ((c def c (c (? . 2) q glob)) q (22255 . 6)) ((c def c (c (? . 0) q gif-add-image)) q (16173 . 17)) ((c def c (c (? . 5) q gzip)) q (3930 . 5)) ((c def c (c (? . 11) q prop:convertible)) q (0 . 41)) ((c def c (c (? . 0) q gif-state)) q (15907 . 3)) ((c def c (c (? . 2) q glob-match?)) q (22721 . 7)) ((c def c (c (? . 0) q gif-add-comment)) q (17275 . 4)) ((c def c (c (? . 4) q exn:fail:unzip:no-such-entry)) c (? . 9)) ((c def c (c (? . 6) q write-icos)) q (18248 . 7)) ((c def c (c (? . 10) q hex-string->bytes)) q (15404 . 3)) ((c def c (c (? . 0) q gif-add-loop-control)) q (17150 . 4)) ((c def c (c (? . 6) q ico->png-bytes)) q (18848 . 3)) ((c def c (c (? . 4) q call-with-unzip)) q (7897 . 4)) ((c def c (c (? . 4) q zip-directory?)) q (8789 . 3)) ((c def c (c (? . 6) q ico?)) q (17703 . 3)) ((c def c (c (? . 11) q convert)) q (2243 . 41)) ((c def c (c (? . 11) q convertible?)) q (2185 . 3)) ((c def c (c (? . 2) q in-glob)) q (22483 . 6)) ((c def c (c (? . 4) q exn:fail:unzip:no-such-entry?)) c (? . 9)) ((c def c (c (? . 0) q color?)) q (15799 . 3)) ((c def c (c (? . 0) q gif-stream?)) q (15471 . 3)) ((c def c (c (? . 0) q gif-colormap?)) q (15740 . 3)) ((c def c (c (? . 6) q ico-format)) q (17984 . 3)) ((c def c (c (? . 4) q make-filesystem-entry-reader)) q (8026 . 13)) ((c def c (c (? . 4) q path->zip-path)) q (10326 . 3)) ((c def c (c (? . 2) q glob/c)) q (22189 . 2)) ((c def c (c (? . 10) q sha1)) q (14946 . 5)) ((c def c (c (? . 6) q read-icos)) q (18053 . 3)) ((c def c (c (? . 12) q cache-file)) q (20269 . 28)) ((q def ((lib "file/untgz.rkt") untgz)) q (14125 . 16)) ((c def c (c (? . 4) q call-with-unzip-entry)) q (10157 . 5)) ((c def c (c (? . 6) q replace-all-icos)) q (18664 . 4)) ((c def c (c (? . 6) q ico-width)) q (17753 . 3)) ((c def c (c (? . 7) q tar->output)) q (11521 . 21)) ((c def c (c (? . 12) q cache-remove)) q (21665 . 11)) ((c def c (c (? . 4) q struct:exn:fail:unzip:no-such-entry)) c (? . 9)) ((c def c (c (? . 0) q gif-start)) q (15977 . 7)) ((c def c (c (? . 6) q replace-icos)) q (18562 . 4)) ((c def c (c (? . 0) q image-ready-gif-stream?)) q (15528 . 3)) ((c def c (c (? . 4) q read-zip-directory)) q (8689 . 3)) ((c def c (c (? . 0) q dimension?)) q (15851 . 3)) ((q def ((lib "file/md5.rkt") md5)) q (14815 . 4)) ((c def c (c (? . 8) q zip)) q (5031 . 20)) ((c def c (c (? . 0) q quantize)) q (17487 . 5)) ((c def c (c (? . 4) q make-exn:fail:unzip:no-such-entry)) c (? . 9)) ((c def c (c (? . 1) q gunzip-through-ports)) q (4842 . 4)) ((c def c (c (? . 6) q read-icos-from-exe)) q (18146 . 3)) ((c def c (c (? . 0) q gif-add-control)) q (16710 . 11)) ((q def ((lib "file/untar.rkt") untar)) q (13435 . 16))))
value
prop:convertible
